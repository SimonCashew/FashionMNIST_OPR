...
def main(cfg: DictConfig):
    ...
    run = wandb.init(project="MNIST_L1", config=cfg_container)
    ...
    def train(
        ...
        def make_step(
            ...
            l1_value, l1_grad = eqx.filter_value_and_grad(l1)(model)

            loss_value += REG_FACTOR * l1_value
            combined_grad = jax.tree_util.tree_map(lambda g, l1: g + REG_FACTOR * l1, grad, l1_grad)
